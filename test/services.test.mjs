...
import { calculateGameXp, GAME_MAX_ATTEMPTS, GAME_QUESTION_LIMIT, isAcceptedGermanAnswer } from '../dist/services/gameSessionService.js';
...
test('collection speech rocket routes reject missing token and never trust client score', () => {
    ...
    assert.match(htmlSource, /interimResults = false/);
    ...
    assert.match(htmlSource, /غلط، حاول مرة ثانية/);
