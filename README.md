...
| الأمر | الوصف |
|-------|-------|
| `/start` | تسجيل المستخدم بالاسم وعرض القائمة |
| `/profile` | الملف الشخصي |
| `/rename` | تغيير الاسم داخل البوت |
| `/achievements` | إنجازات المستخدم |
...
| `/challenge` | تحدي غير متزامن بين المستخدمين |
