...
FROM bot_sessions
WHERE type IN ('learn', 'train', 'add_word', 'challenge', 'register', 'rename', 'support_proof', 'admin_broadcast', 'admin_announcement', 'admin_source', 'csv_update', 'word_selection', 'word_search', 'ai_word', 'train_explain');
